...
5. 使用[自定义容器操作指南](../Custom_Containerized_Environment.zh.md)中当前与
   Harbor 兼容的路径构建：
...
[Determined compute 指南](../Determined_AI_User_Guide.zh.md)、
[MCP 工作流](../Agent_Workflow.zh.md)和
[共享存储指南](../Shared_Storage.zh.md)。
